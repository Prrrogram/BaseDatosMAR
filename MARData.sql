...
--
-- Host: 127.0.0.1    Database: bdescuela
-- ------------------------------------------------------
...
--
-- Current Database: `bdescuela`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `bdescuela` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
CREATE TABLE `Administradores` (
  ...
  `ingresoUsuario` varchar(45) NOT NULL,
  `ingresoContrasenia` varchar(45) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `ingresoUsuario_UNIQUE` (`ingresoUsuario`)
...
CREATE TABLE `Claves` (
  ...
  `ingresoContrasenia` varchar(45) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `ingresoContrasenia_UNIQUE` (`ingresoContrasenia`)
...
INSERT INTO `Claves` VALUES (1,'HOM OCLAVE');
...
CREATE TABLE `Soporte` (
  `id` int NOT NULL AUTO_INCREMENT,
  `Quejas` varchar(45) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `Quejas_UNIQUE` (`Quejas`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping events for database 'bdescuela'
--

--
-- Dumping routines for database 'bdescuela'
--
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2024-12-02 04:23:52',NULL),('diagnostics.include_raw','OFF','2024-12-02 04:23:52',NULL),('ps_thread_trx_info.max_length','65535','2024-12-02 04:23:52',NULL),('statement_performance_analyzer.limit','100','2024-12-02 04:23:52',NULL),('statement_performance_analyzer.view',NULL,'2024-12-02 04:23:52',NULL),('statement_truncate_len','64','2024-12-02 04:23:52',NULL);
...
-- Dump completed on 2024-12-02 11:56:59
